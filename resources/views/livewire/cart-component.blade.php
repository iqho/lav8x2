        ...
        <div class=" main-content-area">
            ...
            <div class="wrap-iten-in-cart">
                ...
                <div class="alert alert-success">
                    <strong>Successfully !</strong> {{ Session::get('success_message') }}
                </div>
                @endif
                @if(Cart::count() > 0)
                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="quantity">
                            <div class="quantity-input">                                
                                <a class="btn btn-increase" href="#" style="margin-right: 15px; margin-left:0px;" wire:click.prevent="increaseQuantity('{{ $item->rowId }}')"></a>
                                <input type="text" value="{{ $item->qty }}" data-max="10" pattern="[0-9]*" style='text-align: center; padding:0px; max-width:70px; margin-right:0px;'>
